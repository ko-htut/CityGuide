package com.albertotorresgi.cityguide.views;
...
/**
 * Custom sliding tab to navigate through BAR, BISTRO and CAFE:
 */
public class SlidingTabView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    @BindView(R.id.slider) TextView mSlider;
    @BindView(R.id.tab_buttons_container) LinearLayout mTabsContainer;
